...
public class TaskCompletedAdapter extends ArrayAdapter<Task> {
    private Context mContext;
    private ArrayList<Task> tasksList;

    TaskCompletedAdapter(@NonNull Context context, ArrayList<Task> list) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (listItem == null)
            listItem = LayoutInflater.from(mContext).inflate(R.layout.item_completed_todo, parent, false);
